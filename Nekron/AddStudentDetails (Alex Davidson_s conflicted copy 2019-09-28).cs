    ...
    public partial class AddStudentDetails : Form
    {
        ...
        private void updateinfo()
        {
            try {
                ...
                cmd.Connection = con;
                cmd.CommandText = "update HRM.students set full_name = '" + usr_fullname.Text + "', email = '"
        ...
        private void AutoFillForm() {
            ...
            cmd.Connection = con;
            cmd.CommandText = "select * from HRM.students where username = '" + usr_name.Text + "'";
        ...
        private void DeleteFromFee() {
            try {
                ...
                cmd.Connection = con;
                cmd.CommandText = "delete from HRM.fee where username = '" + usr_name.Text + "'";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("UserName : " + usr_name.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 100));
            e.Graphics.DrawString("FullName : " + usr_fullname.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 130));
            e.Graphics.DrawString("Email : " + usr_email.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 160));
            e.Graphics.DrawString("ContactNo : " + usr_contactNo.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 190));
            e.Graphics.DrawString("Gender : " + usr_gender.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 220));
            e.Graphics.DrawString("AdmissionDate : " + DateTime.Now, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 250));
            e.Graphics.DrawString("FatherName : " + usr_fathername.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 280));
            e.Graphics.DrawString("MotherName : " + usr_mothername.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 340));
            e.Graphics.DrawString("Date Of Birth : " + usr_DOB.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 370));
            e.Graphics.DrawString("Nationality : " + usr_nationality.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 400));
            e.Graphics.DrawString("Religion: " + usr_religion.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 430));
            e.Graphics.DrawString("Class : " + usr_Class.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 460));
            e.Graphics.DrawString("Section : " + usr_assignedSection.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 490));
            e.Graphics.DrawString("--------------------------------------------", new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 520));
        ...
        private void PopulateSections()
        {
            ...
            cmd.Connection = con;
            cmd.CommandText = "select section_name from HRM.sections";
            DataTable dt = new DataTable();
            con.Open();
            dt.Load(cmd.ExecuteReader());
            con.Close();
        ...
        private int GenerateNewID()
        {
            ...
            cmd.CommandText = "select count(s_id) from HRM.students";
        ...
        private void confirm_Click(object sender, EventArgs e)
        {
         ...
         /*   cmd.Connection = con;
            cmd.CommandText = "insert into HRM.students(s_id, username, full_name, email, contact_no, gender, status" +
                ...
                */
                        ...
                        cmd.Connection = con;
                        cmd.CommandText = "insert into HRM.students values(:s_id, :username, :full_name, :email, :contact_no, :gender, :status" +
                            ", :admission_date, :admission_no, :father_name, :mother_name, :date_of_birth, :nationality, :religion, :class_name, :section_name" +
                            ", :s_roll_no, :password, :guardian_full_name, :guardian_contact_no, :guardian_address, :pre_school, :primary_school, :middle" +
                            ", :middle_yearofpass, :middle_institution, :high_school_ssc, :ssc_yearofpass, :ssc_institution, :higher_secondary_hssc" +
        ...
        private void InsertFeeDetails(int studentID) {
            ...
            cmd.Connection = con;
            cmd.CommandText = "insert into HRM.fee values(:s_id, :s_username, :tution_fee, :lab_charges, :security_charges, :health_services, :total_fee, :avalible_concession, :final_fee, :due_date, :fine)";
