...
namespace Nekron
{
    public partial class UserRegistration : Form
    {
            ...
            else
            {
                if (UserNameValidityCheck())
                {
                    ...
                    if (usr_type.Text.Equals("Admin")){
                        ...
                        OracleConnection con = new OracleConnection("Data Source=XE;User ID=system;password=ali;Unicode=true");
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("RegistrationDate : " + DateTime.Now, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 350));
