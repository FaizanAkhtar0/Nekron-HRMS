    ...
    public partial class AddSalary : Form
    {
        ...
        private void usr_name_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (usr_name.Text.Equals("")) {
                ...
                cmd.Connection = con;
                cmd.CommandText = "select t_id from HRM.teachers where username = '" + usr_name.Text + "'";
        ...
        private void generateSlip_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = con;
            cmd.CommandText = "select * from HRM.salary where username = '" + usr_name.Text + "'";
            DataTable dt = new DataTable();
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("FullName :         " + usr_id.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 230));

            e.Graphics.DrawString("Basic Salary :     " + usr_basic_salary.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 260));
            var datestring = usr_payment_date.Value.ToShortDateString();
            e.Graphics.DrawString("Payment Date :     " + datestring, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 290));
            e.Graphics.DrawString("Mode Of Payment :  " + usr_mode_of_payment.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 310));
            e.Graphics.DrawString("Payment Details :  " + usr_payment_mode_details.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 340));
            e.Graphics.DrawString("Deduction :        " + usr_deduction.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 370));
            e.Graphics.DrawString("TotalPayment :     " + usr_total_payment.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 400));
