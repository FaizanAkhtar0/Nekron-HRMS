    ...
    public partial class AddEmployeeTeacherDetails : Form
    {
        ...
        private void DeleteFromSalary() {
            try {
                ...
                cmd.Connection = con;
                cmd.CommandText = "delete from HRM.salary where username = '" + usr_name.Text + "'";
        ...
        private void updateinfo() {
            try {
                ...
                cmd.Connection = con;
                cmd.CommandText = "update HRM.teachers set full_name = '" + usr_fullname.Text + "', email = '"
        ...
        {try
            {
                ...
                cmd.Connection = con;
                cmd.CommandText = "select * from HRM.teachers where username = '" + usr_name.Text + "'";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            try
            {
                ...
                e.Graphics.DrawString("FatherName : " + usr_fathername.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 310));
                e.Graphics.DrawString("ParmanentAddress : " + usr_permanentAddress.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 340));
                ...
                e.Graphics.DrawString("YearOfExperience : " + usr_yearsOfExperience.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 400));
                e.Graphics.DrawString("CNIC: " + usr_cnic.Text, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 430));
        ...
        {try
            {
                ...
                cmd.Connection = con;
                cmd.CommandText = "insert into HRM.teachers values(:t_id, :username, :full_name, :email, :contact_no, :gender, :status" +
        ...
        private void AddSalaryDetails(int ID) {
            ...
            try {
                ...
                cmd.Connection = con;
                cmd.CommandText = "insert into HRM.salary values(:usr_id, :username, :salary_amount, :payment_date, :mode_of_payment, :payment_mode_details, :deducation_amount, :total_pay)";
        ...
        private int GenerateNewID() {
            ...
            cmd.CommandText = "select count(t_id) from HRM.teachers";
