...
namespace Nekron
{
    public partial class UserRegistration : Form
    {
            ...
            try
            {
                ...
                else
                {
                    if (UserNameValidityCheck())
                    {
                        ...
                        {
                            string con_str = "insert into TEST.admins values(:a_id, :username, :a_password, :full_name, :email, :contact_no, :gender, :status, :registration_date, :image)";
        ...
        private int GenerateNewID() {
            ...
            cmd.CommandText = "select count(a_id) from TEST.admins";
        ...
        private void Delete() {
            try
            {
                ...
                if (usr_type.Text.Equals("Admin"))
                {
                    cmd.CommandText = "delete from TEST.admins where username = " + usr_name.Text;
                }
                else if (usr_type.Text.Equals("Teacher"))
                {
                ...
                {
                    cmd.CommandText = "delete from TEST.parents where username = " + usr_name.Text;
                }
        ...
        private void UpdateInfo() {
            try
            {
                ...
                if (usr_type.Text.Equals("Admin"))
                {
                    cmd.CommandText = "update TEST.admins set full_name = '" + usr_fullname.Text + "', email = '" + usr_email.Text + "', contact_no = '" + usr_contactNo.Text + "', gender = '" + usr_gender.Text + "', status = '" + usr_status.Text + "', a_password = '" + usr_pass.Text + "', image = '" + imgData + "' where username = '" + usr_name.Text + "'"; 
                }
                else if (usr_type.Text.Equals("Teacher"))
                {
                    cmd.CommandText = "update TEST.teachers set full_name = '" + usr_fullname.Text + "', email = '" + usr_email.Text + "', contact_no = '" + usr_contactNo.Text + "', gender = '" + usr_gender.Text + "', status = '" + usr_status.Text + "', a_password = '" + usr_pass.Text + "', image = '" + imgData + "' where username = '" + usr_name.Text + "'";
                }
                else if (usr_type.Text.Equals("Student"))
                {
                    cmd.CommandText = "update TEST.students set full_name = '" + usr_fullname.Text + "', email = '" + usr_email.Text + "', contact_no = '" + usr_contactNo.Text + "', gender = '" + usr_gender.Text + "', status = '" + usr_status.Text + "', a_password = '" + usr_pass.Text + "', image = '" + imgData + "' where username = '" + usr_name.Text + "'";
                }
                else if (usr_type.Text.Equals("Parent"))
                {
                    cmd.CommandText = "update TEST.parents set full_name = '" + usr_fullname.Text + "', email = '" + usr_email.Text + "', contact_no = '" + usr_contactNo.Text + "', gender = '" + usr_gender.Text + "', status = '" + usr_status.Text + "', a_password = '" + usr_pass.Text + "', image = '" + imgData + "' where username = '" + usr_name.Text + "'";
                }
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("RegistrationDate : " + DateTime.Now, new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 250));
            e.Graphics.DrawString("--------------------------------------------", new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, new Point(25, 280));
        }
        ...
        private void usr_gender_SelectedIndexChanged(object sender, EventArgs e)
        {
